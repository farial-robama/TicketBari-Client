...
const Footer = () => {
  ...
  <nav>
    ...
    <p className='text-sm'>Book bus, train, launch & <br />flight tickets easily.</p>
  </nav>
  <nav>
  ...
  <nav> 
    ...
    <div>
      <img src="https://img.icons8.com/?size=100&id=23671&format=png" alt="Stripe" className='h-8' />
    </div>
  </nav>
</footer>
