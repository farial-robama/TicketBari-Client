...
const Navbar = () => {
  ...
  const navLinkClass = ({ isActive }) => `px-8 py-2 rounded-md font-semibold transition ${isActive ? 'text-primary border-b-2 border-primary' : 'text-gray-600 hover:text-primary'}`
                  ...
                  <div className='flex flex-col cursor-pointer'>
                    ...
                    {user ? (
                      <>
                        ...
                        <button onClick={() => setTheme(theme === "dark" ? "light" : "dark")} className=" toggle  px-4 rounded-4xl bg-[#6E8CFB] dark:bg-[#B7E5CD] ml-3">
