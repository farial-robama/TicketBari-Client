...
const Banner = () => {
  return (
    ...
    <img
      ...
      <div className='absolute inset-0 flex flex-col justify-center items-center text-center text-white px-6'>
        <h2 className='text-3xl font-bold mb-4'>Seamless Travel, Every Time</h2>
        <p>Book your tickets in seconds. Whether it's a daily commute or a cross-country adventure, <br />we provide the most reliable routes at the best prices.</p>
      </div>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img
      ...
      <div className='absolute inset-0 flex flex-col justify-center items-center text-center text-white px-6'>
        <h2 className='text-3xl font-bold mb-4'>Premium Comfort on Every Route</h2>
        <p>experience top-tier amenities and punctuality. <br />Join over 1 million happy travelers who trust our platform for their journey.</p>
      </div>
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide4" className="btn btn-circle">❮</a>
      <a href="#slide2" className="btn btn-circle">❯</a>
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img
      ...
      <div className='absolute inset-0 flex flex-col justify-center items-center text-center text-white px-6'>
        ...
        <p>Don't just deam about it-get there. From hidden gems to popular city hubs, <br />our extensive network connects you to the places that matter most.</p>
      </div>
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide4" className="btn btn-circle">❮</a>
      <a href="#slide2" className="btn btn-circle">❯</a>
