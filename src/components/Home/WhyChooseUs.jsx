...
const WhyChooseUs = () => {
  return (
    <div className="mx-auto">
      <div className="flex flex-col-reverse md:flex-row gap-10 justify-between items-center my-18">
        <div className="flex flex-col gap-5">
          <h1 className=" text-gray-600 text-3xl font-bold">
            Why Book Your Tickets With Us?
          </h1>
          <p className="text-gray-600 text-xl">
            We are more than just a booking site. <br />{" "}
            <span className="font-bold">TicketBari</span> connects you to
            thousands of routes with verified operators, ensuring your journey
            is safe, affordable, and on time.
          </p>
        </div>

        <img
          className="rounded-md md:w-130 w-full"
