    ...
    <div className="max-w-4xl mx-auto my-12 bg-white p-8 rounded-md shadow-2xl text-gray-900">
        ...
        <div>
          ...
          <select
            {...register("transportType", {
              required: "Transport typ is required",
            })}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
          >
      ...
      focus:outline-none"
        ...
        <button
          type="submit"
          disabled={uploading}
          className="w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition duration-200 font-semibold text-lg disabled:bg-gray-400 disabled:cursor-not-allowed mt-5"
        >
