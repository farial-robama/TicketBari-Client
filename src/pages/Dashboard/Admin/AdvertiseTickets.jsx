                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <button
                        ...
                        className={`px-4 py-2 rounded font-semibold transition disabled:bg-gray-400 ${
                          ticket.isAdvertised
